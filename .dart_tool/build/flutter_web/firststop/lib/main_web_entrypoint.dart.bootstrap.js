...
let modulePaths = {
 ...
 "packages/firststop/main": "packages/firststop/main.ddc",
 "packages/firststop/main_web_entrypoint": "packages/firststop/main_web_entrypoint.ddc",
 "packages/firststop/models/User": "packages/firststop/models/User.ddc",
 "packages/firststop/pages/auth_page": "packages/firststop/pages/auth_page.ddc",
 "packages/firststop/pages/data_page": "packages/firststop/pages/data_page.ddc",
 "packages/firststop/pages/home_page": "packages/firststop/pages/home_page.ddc",
 "packages/firststop/pages/root_page": "packages/firststop/pages/root_page.ddc",
 "packages/firststop/utils/auth": "packages/firststop/utils/auth.ddc",
 "packages/firststop/utils/centered_view": "packages/firststop/utils/centered_view.ddc",
 "packages/firststop/utils/responsive_widget": "packages/firststop/utils/responsive_widget.ddc",
 ...
 "packages/percent_indicator/circular_percent_indicator": "packages/percent_indicator/circular_percent_indicator.ddc",
 "packages/percent_indicator/linear_percent_indicator": "packages/percent_indicator/linear_percent_indicator.ddc",
 "packages/percent_indicator/percent_indicator": "packages/percent_indicator/percent_indicator.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/firststop/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:firststop/main_web_entrypoint.dart") {
          // Clear static caches.
